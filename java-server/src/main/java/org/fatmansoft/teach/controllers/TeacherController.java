...
public class TeacherController {
    ...
    public DataResponse getTeacherByNum(@Valid @RequestBody DataRequest dataRequest) {
        String num = dataRequest.getString("num");
        Person op = personRepository.findPersonByNum(num);
        Teacher t=teacherRepository.getTeacherByPerson(op);
