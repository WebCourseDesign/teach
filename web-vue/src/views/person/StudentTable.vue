<template>
  ...
  <div class="base_form">
    ...
    <!-- 查询区域 -->
    <div class="base_query_container">
      <div class="query_wrapper">
        <!-- 左边操作按钮组 -->
        <div class="query_left">
          <el-button type="primary" @click="addItem()" size="large" class="commButton">添加</el-button>
        </div>
        <!-- 右边查询组 -->
        <div class="query_right">
          <el-input v-model="numName" placeholder="学号或姓名" class="query-input"></el-input>
          <div class="button-group">
            <el-button class="subButton" @click="doQuery()">查询</el-button>
            <el-button class="subButton" @click="doExport()">导出</el-button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="table-responsive">
      ...
      }" :row-style="{ height: '10px' }" :cell-style="{ padding: '2px' }" style="width: 100%" class="responsive-table">
        ...
        <el-table-column label="操作" color="black" align="center" width="260">
          <template v-slot="scope">
            <el-button-group round>
              ...
              <el-button @click="editItem(scope.row.studentId)" type="default" color="#626aef" plain
                size="small">基本信息</el-button>
              <el-button @click="familyMember(scope.row.studentId)" type="warning" size="small">家庭成员</el-button>
              <el-button @click="deleteItem(scope.row.studentId)" type="danger" size="small">删除</el-button>
            </el-button-group>
          </template>
        </el-table-column>
      </el-table>
