...
//   return res as DataResponse;
// }
export const courseSave = (data) => {
  return request({
    url: '/api/course/courseSave',
    method: 'post',
    data: { data }
  })
}
...
export const getCourseByTeacher = () => {
  return request({
    url: '/api/course/getCourseByTeacherGET',
    method: 'get'
  })
}

export async function getCourseItemOptionListByTeacher(): Promise<OptionItem[]> {
  const res = await generalRequest("/api/course/getCourseByTeacher", null);
  return res.itemList as OptionItem[];
}

export const getTeacherList = () => {
  return request({
    url: '/api/teacher/getTeacherIdList',
    method: 'get'
  })
}

export async function getPendingCourses(): Promise<DataResponse> {
  const res = await generalRequest("/api/course/getPendingCourses", null);
  return res as DataResponse;
}
